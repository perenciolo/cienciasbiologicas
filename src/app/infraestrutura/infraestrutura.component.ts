...
const menuAPI = environment.infraestruturaMenuAPI;
const paginasAPI = environment.infraestruturaPaginasAPI;
const galeriaAPI = environment.galeriaAPI;

@Component({
  selector: 'cb-infraestrutura',
  templateUrl: './infraestrutura.component.html',
  styleUrls: ['./infraestrutura.component.sass']
})
